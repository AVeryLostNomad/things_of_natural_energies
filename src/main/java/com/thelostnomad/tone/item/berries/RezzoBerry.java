...
public class RezzoBerry extends ItemFood {
    ...
    public RezzoBerry()
    {
        ...
        setUnlocalizedName(ThingsOfNaturalEnergies.MODID + ".berry_rezzo_item");     // Used for localization (en_US.lang)
        setRegistryName("berry_rezzo_item");        // The unique name (within your mod) that identifies this block
    }
