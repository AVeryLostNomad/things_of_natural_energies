...
public class BlockPuller extends BlockContainer implements ITree {
    ...
    public BlockPuller() {
        ...
        setUnlocalizedName(ThingsOfNaturalEnergies.MODID + ".puller");
        setRegistryName("puller");
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (tileentity instanceof TESentientTreeCore) { // prevent a crash if not the right type, or is null
            ...
            TEPuller thisPuller = (TEPuller) worldIn.getTileEntity(pos);
