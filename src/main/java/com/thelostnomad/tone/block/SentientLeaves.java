...
public class SentientLeaves extends Block implements net.minecraftforge.common.IShearable, ITree {
    protected boolean leavesFancy;
    int[] surroundings;

    public SentientLeaves() {
        ...
        setUnlocalizedName(ThingsOfNaturalEnergies.MODID + ".sentient_leaves");     // Used for localization (en_US.lang)
        setRegistryName("sentient_leaves");
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        // A sentient leaf does not decay.
        return;
    }
    ...
    public List<ItemStack> onSheared(@Nonnull ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
        return new ArrayList<ItemStack>(); // Return nothing on shear for now. Maybe later return crystal-life.
    }
