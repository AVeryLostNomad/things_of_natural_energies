...
public class InventoryExtraSlot implements IInventory
{
    /** A list of one item containing the result of the crafting formula */
    private final NonNullList<ItemStack> stackResult = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
    private IRecipe recipeUsed;
    private TELivingCraftingStation tile;
    private int greaterSlot = 0;

    public InventoryExtraSlot(int actualSlot, TELivingCraftingStation tile){
        this.tile = tile;
        this.greaterSlot = actualSlot;
    }
