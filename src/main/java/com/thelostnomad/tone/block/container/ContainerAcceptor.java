...
public class ContainerAcceptor extends Container implements SyncableContainer {

    private TEAcceptor teAcceptor;
    ...
    public ContainerAcceptor(InventoryPlayer invPlayer, TEAcceptor tileAcceptor) {
        this.teAcceptor = tileAcceptor;
        ...
        addSlotToContainer(new Slot(teAcceptor, 36, 79, 18));
    }
    ...
    {
        return teAcceptor.isUsableByPlayer(player);
    }
    ...
    public void onContainerClosed(EntityPlayer playerIn)
    {
        ...
        this.teAcceptor.closeInventory(playerIn);
    }
