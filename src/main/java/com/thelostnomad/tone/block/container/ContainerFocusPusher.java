...
public class ContainerFocusPusher extends Container implements SyncableContainer {

    private TEFocusPusher teFocusPusher;
    ...
    public ContainerFocusPusher(InventoryPlayer invPlayer, TEFocusPusher tileFocusPusher) {
        this.teFocusPusher = tileFocusPusher;
        ...
        addSlotToContainer(new Slot(teFocusPusher, 36, 151, 19));
    }

    public SyncableTileEntity getSyncableTileEntity() {
        return teFocusPusher;
    }
    ...
    {
        return teFocusPusher.isUsableByPlayer(player);
    }
    ...
    public void onContainerClosed(EntityPlayer playerIn)
    {
        ...
        this.teFocusPusher.closeInventory(playerIn);
    }
