...
public class TEPuller extends TileEntity implements IInventory, IInteractable {

    public static final String NAME = "tone_puller_tileentity";
    ...
    public InteractableType getType() {
        return InteractableType.PULLER;
    }
}
